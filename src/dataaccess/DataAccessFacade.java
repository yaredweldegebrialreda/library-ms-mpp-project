...
public class    DataAccessFacade implements DataAccess {
    ...
    public void saveCheckoutRecord(CheckoutRecord newCheckoutRecord) throws RessourceException {
        ...
        String memberId = newCheckoutRecord.getMemberId();
        CheckoutRecord existingCheckoutRecord=checkoutRecords.get(memberId);
        existingCheckoutRecord.addEntry(newCheckoutRecord.getEntries().get(0));
        checkoutRecords.put(memberId, existingCheckoutRecord);
    ...
    public void addBookCopy(String isbn) throws RessourceException {
        ...
        if(book ==null ){
            throw new RessourceException("Book",isbn," doesn't exist !");
        }
        book.addCopy();
